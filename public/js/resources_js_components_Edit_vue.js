        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.axios.get("/api/tarea/".concat(_this.$route.params.id)).then(function (response) {
                  var _response$data = response.data,
                      tarea = _response$data.tarea,
                      status = _response$data.status,
                      data = _response$data.data;
                  _this.tarea.tarea = tarea;
                  _this.tarea.status = status;
                  _this.tarea.data = data;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this2.axios.post("/api/tarea/".concat(_this2.$route.params.id), _this2.tarea).then(function (response) {
                  _this2.$router.push({
                    name: "tareaList"
                  });
                })["catch"](function (error) {
